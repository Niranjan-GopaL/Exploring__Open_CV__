...
cap = cv2.VideoCapture('Videos/Pose_1.mp4')
...
def resize_saviour(capture, scale_percent = 40) :
...
while 1:
    ...
    cv2.putText(resized_img, str(round(fps,2)) , (40,40) , cv2.FONT_HERSHEY_PLAIN , 3 , (255,0,255) )
